  ...
  return (
    ...
    >
      ...
      <div className="space-y-10 px-0 md:px-10">
        ...
        <p className="mt-10 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
          UNSOBER BAR - это уникальное место, где современная гастрономия встречается с
          традиционными рецептами. Наш ресторан основан в 2020 году с целью создать
          уникальное пространство, где каждый гость сможет насладиться изысканной
          кухней. Наши повара экспериментируют с текстурами, формами и необычными
          вкусами, создавая неповторимые кулинарные шедевры, а бармены удивляют
          авторскими коктейлями, которые стали визитной карточкой нашего заведения.
        </p>
      </div>
    </motion.div>
  );
